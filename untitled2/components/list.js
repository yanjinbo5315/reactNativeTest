...
export default class List extends Component {
    ...
    _renderItem=({item})=>{
        return (
            <TouchableOpacity style={ListCss.flex}>
        ...
        return (
            <View style={ListCss.contain}>
                <View style={{backgroundColor:"white"}}>
                    <TextInput style={ListCss.textInput} value={this.state.value} onChangeText={this._changeText.bind(this)} underlineColorAndroid="transparent" placeholder="请输入关键字进行查询" />
                </View>
                <View>
                    <FlatList
